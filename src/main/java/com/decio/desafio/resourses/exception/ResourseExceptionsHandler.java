...
@ControllerAdvice
public class ResourseExceptionsHandler {
...
//	public ResponseEntity<StandardError> argumentoInvalido(MethodArgumentNotValidException e, HttpServletRequest request) {
//		StandardError err = new StandardError(HttpStatus.BAD_REQUEST.value(), e.getMessage(), System.currentTimeMillis());
//		return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(err);
//	}
